...
export const DesignDetailPage: React.FC = () => {
  ...
  const generateTearsheet = async () => {
    ...
    const contentWidth = pageWidth - (margin * 2);
      ...
      doc.text('RUGVISION.CA', margin, 20);
    ...
    doc.text('RUGVISION.CA • Luxury Custom Rugs', pageWidth / 2, footerY, { align: 'center' });
    doc.text('Email: jenna@opulmkt.com • www.rugvision.ca', pageWidth / 2, footerY + 5, { align: 'center' });
