      ...
      {isAdmin ? (
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* Admin Pricing Simulation */}
            <div className="lg:col-span-2 bg-white p-8 rounded-[2.5rem] border border-black/10 shadow-sm">
              <div className="flex justify-between items-center mb-8 border-b border-black/5 pb-4">
                <h3 className="text-sm font-bold uppercase tracking-widest flex items-center gap-2">
                  <DollarSign className="w-4 h-4 text-[#EFBB76]" /> Pricing Engine Simulation
                </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-6">
                  <h4 className="text-[10px] font-black uppercase tracking-widest text-black/40">Construction Base Rates</h4>
                  <div className="space-y-4">
                    {[
                      { label: 'Hand-Tufted', value: '45.00' },
                      { label: 'Hand-Knotted (60k)', value: '85.00' },
                      { label: 'Hand-Knotted (100k)', value: '125.00' },
                      { label: 'Flatweave', value: '35.00' }
                    ].map((item, i) => (
                      <div key={i} className="flex flex-col gap-1">
                        <label className="text-[8px] font-bold uppercase tracking-widest text-black/40">{item.label} ($/sqft)</label>
                        <div className="flex items-center gap-2">
                          <input type="number" defaultValue={item.value} className="flex-1 p-2 bg-black/5 rounded-lg text-xs font-bold outline-none border border-transparent focus:border-[#EFBB76]" />
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="space-y-6">
                  <h4 className="text-[10px] font-black uppercase tracking-widest text-black/40">Material Multipliers</h4>
                  <div className="space-y-4">
                    {[
                      { label: 'New Zealand Wool', value: '1.0' },
                      { label: 'Bamboo Silk Blend', value: '1.2' },
                      { label: 'Pure Silk', value: '1.8' },
                      { label: 'Mohair', value: '1.5' }
                    ].map((item, i) => (
                      <div key={i} className="flex flex-col gap-1">
                        <label className="text-[8px] font-bold uppercase tracking-widest text-black/40">{item.label} (x)</label>
                        <div className="flex items-center gap-2">
                          <input type="number" step="0.1" defaultValue={item.value} className="flex-1 p-2 bg-black/5 rounded-lg text-xs font-bold outline-none border border-transparent focus:border-[#EFBB76]" />
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="space-y-6">
                  <h4 className="text-[10px] font-black uppercase tracking-widest text-black/40">Technical Add-ons</h4>
                  <div className="space-y-4">
                    {[
                      { label: 'Pile Height (>12mm)', value: '5.00' },
                      { label: 'Carving / Embossing', value: '3.50' },
                      { label: 'Lurex Accents', value: '8.00' },
                      { label: 'Custom Dye Match', value: '150.00' }
                    ].map((item, i) => (
                      <div key={i} className="flex flex-col gap-1">
                        <label className="text-[8px] font-bold uppercase tracking-widest text-black/40">{item.label} ($)</label>
                        <div className="flex items-center gap-2">
                          <input type="number" defaultValue={item.value} className="flex-1 p-2 bg-black/5 rounded-lg text-xs font-bold outline-none border border-transparent focus:border-[#EFBB76]" />
                        </div>
                      </div>
              ...
              <div className="mt-12 pt-8 border-t border-black/5 flex justify-end gap-4">
                <button className="px-8 py-3 bg-black/5 text-black/40 text-[10px] font-black uppercase tracking-widest rounded-full hover:bg-black/10 transition-all">
                  Reset Defaults
                </button>
                <button className="px-8 py-3 bg-[#F0F7FF] text-blue-600 text-[10px] font-black uppercase tracking-widest rounded-full hover:bg-blue-100 transition-all shadow-lg">
                            ...
                            <div key={log.id} className="p-4 bg-white/5 rounded-2xl border border-white/5 space-y-3">
                              <div className="flex items-center justify-between">
                                ...
                                <span className={`text-[8px] font-black uppercase tracking-widest px-3 py-1 rounded-full ${
                                  ...
                                  log.status === 'processing' ? 'bg-[#F0F7FF] text-blue-600' :
